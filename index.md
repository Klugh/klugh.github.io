...
ADD® is an eDiscovery workflow tool that orchestrates everything from media management, high-speed data processing, culling, and tracking, OCR processing, forensic file management, early case assessment, advanced analytical review, user and case management, along with production and case reporting.
