...
Coaching software development teams in living the values and principles of Agile to satisfy the customers’ needs while building products that will easily support changes so that it can continue to meet those needs throughout its lifetime.  This is accomplished through continuous development of an Agile and DevOps mindset, while focusing the team on technical excellence.
